...
<script>
	import provinceData from './city-data/area0.js';
	import cityData from './city-data/area1.js';
	import areaData from './city-data/area2.js';
	export default {
		data() {
			return {
				pickerValue: [0, 0, 0],
		...
		methods: {
			...
			_getLabel() {
				let pcikerLabel =this.provinceDataList[this.pickerValue[0]].name +'-' +this.cityDataList[this.pickerValue[1]].name +'-' +this.areaDataList[this.pickerValue[2]].name;
